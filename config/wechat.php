...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx8a1533aceba5ecf7'),         // AppID
    'secret'  => env('WECHAT_SECRET', '3a819b31ac0a145f6e6bcffba1c7289c'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'kAptQRDXmDSciLbJeBh5k0iR6AmUiirk'),          // Token
